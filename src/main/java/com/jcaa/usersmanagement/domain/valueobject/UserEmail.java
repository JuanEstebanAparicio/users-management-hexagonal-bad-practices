...
//ELIMINAR EL CAMPO LOGGER
import java.util.regex.Pattern;

public record UserEmail(String value) {

  // VIOLACIÓN Regla 6: logging en capa de dominio (el dominio no debe tener logs)
  // SOLUCION: ELIMINAR EL CAMPO LOGGER POR QUE LA CAPA DE DOMINIO NO DEBE TENER
  // LOGS
  ...
  public UserEmail {
    ...
    // 2. UserValidationUtils.isValidEmail(): validación simplificada con
    // contains("@")
